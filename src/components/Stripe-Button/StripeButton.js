...
const StripeCheckoutButton = ({ price, order, onOrder, cartItems, setCartItems, setOrder, history }) => {
  ...
  return (
    ...
    >
      <button style={{ marginBottom: '2rem' }} className="btn btn-outline-primary btn-block btn-lg">
